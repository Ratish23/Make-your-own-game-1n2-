function preload(){
 ...
 option1=loadImage("Whitegun1.png");
 option2=loadImage("Whitegun2.png");
 option3=loadImage("Blackgun1.png");
 option4=loadImage("Blackgun2.png");
...
function setup() {
  ...
  Whitegun1= createSprite(375,200);
  Whitegun1.addImage(option1);
